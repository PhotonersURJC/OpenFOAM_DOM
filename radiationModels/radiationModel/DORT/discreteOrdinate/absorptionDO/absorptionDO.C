...
Foam::radiation::absorptionDO::absorptionDO
(
    const DORT& dort,
...
Foam::scalar Foam::radiation::absorptionDO::correct
()
{
...
void Foam::radiation::absorptionDO::setBandScatter
 (const label lambdaI, const volScalarField value)
 {}

void Foam::radiation::absorptionDO::changeBand
 (const label lambdaI)
{
	IOobject IHeader
    (
