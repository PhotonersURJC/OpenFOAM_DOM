...
Foam::radiation::blackBodyEmissionRev::emissivePowerTable
(
    IStringStream
    (
        "("
...
Foam::radiation::blackBodyEmissionRev::blackBodyEmissionRev
(
    const label nLambda,
...
Foam::scalar Foam::radiation::blackBodyEmissionRev::fLambdaT
(
...
void Foam::radiation::blackBodyEmissionRev::resizeBands(const label nBands)
{
	bLambda_.resize(nBands);
	forAll(bLambda_, lambdaI)
    {
        bLambda_.set
        (
...
void Foam::radiation::blackBodyEmissionRev::correct
(
    const label lambdaI,
    const Vector2D<scalar>& band
)
